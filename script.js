...
textBox.addEventListener("keyup", function(e) {
    if(e.keyCode === 13){
        ...
        //Bobby response
        setTimeout(function (){
            let bobby = document.createElement('p');
            bobby.innerText = responses[Math.floor(Math.random()*responses.length)];
            bobby.classList.add('bobby');
            chatContainer.appendChild(bobby);
        }, 1000);
    }
});
